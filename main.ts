/**
* Functions to micro:bit Stella Robot Kit by Ahead.IO Limited.
*/
//% color=#8600FF icon="\uf1b0"
//% block="stella" blockId="Stella"
namespace stella {
    ...
    */
    ...
    //% group="Basic"
    //% weight=196
    //%block="get STELLA's current power"
    ...
    //% group="Set Servo"
    //% weight=194
    //% block="set STELLA %part leg servo %on_off"
    ...
    /*设置机器狗为"pose1"状态*/
    //% weight=166
    //% block="Setting the STELLA to %posestate state"
    ...
    */
    //% weight=200
    //% block="Record the current status of the STELLA as %posestate"
    ...
    //% group="Sports"
    //% weight=192
    //% block="set STELLA to rotate around the %direction_xyz axis with a period of %period seconds"
    ...
    //% group="Sports"
    //% weight=190
    //% block="stop the periodic rotation of STELLA around the %direction_xyz axis"
    ...
    //% group="Sports"
    //% weight=188
    //% block="set STELLA to be rotated %angle degrees about the %direction_xyz axis"
    ...
    //% group="Sports"
    //% weight=187
    //% block="stop the periodic translation of STELLA in the  %direction_xyz direction"
    ...
    //% group="Sports"
    //% weight=186
    //% block="set STELLA to move back and forth in the %direction_xyz direction with a period of %period seconds"
    ...
    //% group="Sports"
    //% weight=185
    //% block="set the STELLA's body to pan %distance mm in the %direction_xyz direction"
    ...
    //% group="Sports"
    //% weight=184
    //% block="set STELLA execution to run in place at a fixed frequency at a leg lift height of %mm mm for %time seconds"
    //% mm.min=11 mm.max=35
    ...
    //% group="Sports"
    //% weight=183
    //% block="set STELLA execution to run in place at a fixed frequency at a leg lift height of %mm mm"
    //% mm.min=11 mm.max=35
    ...
    //% group="Sports"
    //% weight=188
    //% block="set STELLA to perform a %direction rotation at a speed of %speed degrees per second for %time seconds"
    ...
    //% group="Sports"
    //% weight=181
    //% block="set STELLA to perform a %direction rotation at a speed of %speed degrees per second"
    //% speed.min=0 speed.max=150
    ...
    //% group="Sports"
    //% weight=186
    //%block="set STELLA to perform a %direction translational motion with a step size of %step mm for %time seconds"
    ...
    //% group="Sports"
    //% weight=179
    //%block="set STELLA to perform a %direction translational motion with a step size of %step mm"
    //% step.min=5 step.max=25
    ...
    //% weight=192
    //% deprecated=true
    //% block="%on_off STELLA performance mode"
